...
| "Lack of technical stuff" — the model was only planned | A neural network, trained against the real simulator through a Node↔Python protocol, running in the browser and beating the fixed plan by 10.8% |
...
| **Trained model** | **31.46 s — 10.8% better than fixed** |
...
6. **Step 5.** Hand control to the trained model. Say the number: 10.8% better
